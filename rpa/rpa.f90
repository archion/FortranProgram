program RPA
	...
	complex(8) :: H(4,4),Uk(4,4),Ukq(4,4),WORK(20),Xq(2,2,-mq:mq,-mq:mq),Xq_tmp(2,2),eka,dk
	integer :: i,j,k,l,m,n,o,p,INFO
	real(8) :: kx,ky,qx,qy,kqx,kqy,w,e1(2),e2(2),ek(4),ekq(4),fk(4),fkq(4),RWORK(10),Jq,&
			eks,bt,sp,sa,sb,wide,n1,Xq_RPA,u2(2),v2(2),cs2(2)
	...
	do while(flag0)
		...
		n1=0d0
		Xq=0d0
		!$OMP PARALLEL DO REDUCTION(+:n1,Xq) PRIVATE(kx,ky,eka,eks,fk,UK,H,ek,ekq,work,rwork,info,qx,qy,kqx,kqy,&
					...
					if(flag0) then
						do o=1,3*ms-1
							...
							H=reshape((/ dcmplx(real(eka)+eks,0d0), dcmplx(0d0,dimag(eka)),    dk,     (0d0,0d0),        &
										 ...
										 (0d0,0d0), dconjg(-dk), dcmplx(0d0,-dimag(eka)),  dcmplx(-eks+real(eka),0d0) /),(/4,4/))
							call ZHEEV( "V", "U", 4, H, 4, ek, WORK, 20, RWORK, INFO )
							write(20,"(8e16.3)")(ek(l),abs(H(1,l)),l=1,4)
						enddo
					endif
					flag0=.false.
					!$OMP END CRITICAL
