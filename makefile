...
#FCCFLAG_64= -lmy -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -liomp5 -lpthread -lmkl_lapack95_lp64 -lnlopt -lm
...
FCCFLAG_64= -lmy -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -liomp5 -lpthread -lmkl_lapack95_lp64 -lnlopt -lm
all:$(out)
%.out: %.o
	$(FCC) $< -o $@ $(FCCFLAG_$(ARCH))
%.o: %.f90
