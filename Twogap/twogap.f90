program main
	...
	integer,parameter :: mk=1024,mth=100000,ms=100,mr=1024
	complex(8),parameter :: img=(0d0,1d0)
	real(8) :: eka,eks,e1(2),e2(2),e(4),kx,ky,n,US,USp,sp=-0.2,sa,sb,sp0,dk,dt(2),dtp(2),gk(2),hn(4),wide,tmp,tmp1,tmpa,z,th,gap,&
		u2(2),v2(2),uv(2),cos2,sin2,sc,h(4,4),work(15),gm(4,2),rtmp(4,4,4,2),f(4),R(2),omg,DOS,d,omgp,Rp(2),DOSp,M_omg,DOS1
	integer :: i,j,k,l,p,a,b,info,m1,m2,Mn
