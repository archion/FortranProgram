...
do for[i=0:(ix*iy-1)]{
	...
	plot [:1.5][0.2:1.3] for[j=0:14:1] "ramantemp.dat" index j using 1:i+2:(100.) lc j smooth acsplines notitle, for[j=0:14:1] '' index j every 5 using 1:i+2 with point lc j pt j+1 ps 0.5 title sprintf("%1.3f",0.1+0.005*j)
	unset label
	unset format
}
#data
